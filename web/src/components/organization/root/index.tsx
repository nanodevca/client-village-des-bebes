...
const OrganizationContent = () => {
  return (
    <>
      <div className="w-full h-[110rem] lg:h-[60rem] grid grid-rows-6 lg:grid-rows-1 lg:grid-cols-2">
        ...
        <div className="h-full w-full row-span-4 lg:row-span-1 lg:col-span-1 p-10">
          ...
          <div className="w-full mt-5 px-0 py-1 lg:px-5 lg:py-2 hidden lg:block">
            <div className="columns-1 md:columns-3 lg:columns-3">
              <Link href="/organization/who-we-are">
              ...
              <Link href="/organization/founders">
                <div className="relative mb-4 before:content-[''] before:rounded-md before:absolute before:inset-0 before:bg-black before:bg-opacity-20">
                  <Image
                    alt=""
                    width={1000}
                    height={1000}
                    className="w-full rounded-lg"
                    src="/assets/images/organization/IMG_1305.jpg"
                  />
                  <div className="absolute inset-0 p-2 text-white flex flex-col justify-end">
                    <div className="relative">
                      <h1 className="text-2xl font-bold mb-3">
                        Les fondatrices et l&apos;histoire
                      </h1>
                    </div>
                  </div>
                </div>
              ...
              <Link href="/organization/board-of-directors">
                <div className="relative mb-4 before:content-[''] before:rounded-md before:absolute before:inset-0 before:bg-black before:bg-opacity-20">
                  <Image
                    alt=""
                    width={1000}
                    height={1000}
                    className="w-full rounded-lg"
                    src="/assets/images/organization/executives-desk.jpg"
                  />
                  <div className="absolute inset-0 p-2 text-white flex flex-col justify-end">
                    <div className="relative">
